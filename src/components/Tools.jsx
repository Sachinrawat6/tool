...
export const header_with_url = [
  ...
  },
  {
   ...
   {
    header: "Pattern Tracker",
    url: "https://patterntracker.netlify.app/",
    icon: <FaSearch />,
  },
   {
  ...
  },
   {
    ...
    // url: "https://fabricpro.netlify.app",
     ...
     // url:"https://fabricprov4.netlify.app",
     url:"https://fabricprov5.netlify.app",
    icon: <FaBoxes />,
  },
   {
    header: "Scan Clone",
   ...
   {
    header: "Stylewise",
    url: "https://stylewisev5.netlify.app/",
    icon: <FaWarehouse />,
  },
  {
